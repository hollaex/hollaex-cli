...
function hollaex_pull_and_apply_exchange_data() {
  ...
  local ESCAPED_HOLLAEX_CONFIGMAP_LOGO_BLACK_PATH=${ORIGINAL_CHARACTER_FOR_LOGO_BLACK_PATH//\//\\/}}
  local PARSE_CHARACTER_FOR_LOGO_BLACK_PATH=${ORIGINAL_CHARACTER_FOR_LOGO_BLACK_PATH//\//\\/}
  local HOLLAEX_CONFIGMAP_LOGO_BLACK_PATH_OVERRIDE="$PARSE_CHARACTER_FOR_LOGO_BLACK_PATH"

  #CAPTCHA SITEKEY
  local HOLLAEX_CONFIGMAP_CAPTCHA_SITE_KEY_OVERRIDE="$(echo $BITHOLLA_USER_EXCHANGE_LIST | jq -r ".data[$BITHOLLA_USER_EXCHANGE_ORDER].info.tech.HOLLAEX_CONFIGMAP_CAPTCHA_SITE_KEY";)"
  ...
  #CAPTCHA SECRETKEY
  local HOLLAEX_SECRET_CAPTCHA_SECRET_KEY_OVERRIDE="$(echo $BITHOLLA_USER_EXCHANGE_LIST | jq -r ".data[$BITHOLLA_USER_EXCHANGE_ORDER].info.tech.HOLLAEX_SECRET_CAPTCHA_SECRET_KEY";)"
  ...
  sed -i.bak "s/HOLLAEX_SECRET_CAPTCHA_SECRET_KEY=$HOLLAEX_SECRET_CAPTCHA_SECRET_KEY/HOLLAEX_SECRET_CAPTCHA_SECRET_KEY=$HOLLAEX_SECRET_CAPTCHA_SECRET_OVERRIDE/" $SECRET_FILE_PATH
