...
function generate_settings_configmap() {
...
HOLLAEX_CONFIGMAP_DOMAIN=http://localhost
...
HOLLAEX_CONFIGMAP_API_HOST=http://localhost/api
...
ENVIRONMENT_DOCKER_IMAGE_REDIS_REGISTRY=redis
ENVIRONMENT_DOCKER_IMAGE_REDIS_VERSION=6.2.6-alpine
...
ENVIRONMENT_KUBERNETES_S3_BACKUP_CRONJOB_RULE='0 1,13 * * *'
ENVIRONMENT_KUBERNETES_S3_BACKUP_CRONJOB_REGION=
ENVIRONMENT_KUBERNETES_S3_BACKUP_CRONJOB_BUCKET=
ENVIRONMENT_KUBERNETES_S3_BACKUP_CRONJOB_TIMEZONE=UTC
...
function generate_settings_secret() {
